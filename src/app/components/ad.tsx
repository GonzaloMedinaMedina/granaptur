...
const Ad: React.FC<iAd> = ({adInfo}) =>
{
  ...
  return (
    <a className="md:mx-10 shadow-container justify-items-center w-fit flex-col relative flex lg:p-5 border-2 bg-adblueback/30 border-adblueback rounded-xl w-auto sm:w-[480px] lg:w-[580px] xl:w-[640px]" href={url} onClick={handleClick}>
